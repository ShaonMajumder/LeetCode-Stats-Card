...
export function Root(config, data) {
  return new Item("svg", {
    id: "root",
    attr: {
      width: config.width,
    ...
    children: [
      ...
      new Item("style", {
        id: "default-colors",
        content:
          "svg{opacity:0}:root{--bg-0:#fff;--bg-1:#e5e5e5;--bg-2:#d3d3d3;--bg-3:#d3d3d3;--text-0:#000;--text-1:#808080;--text-2:#808080;--text-3:#808080;--color-0:#ffa116;--color-1:#5cb85c;--color-2:#f0ad4e;--color-3:#d9534f}",
      }),
      new Item("rect", {
        id: "background",
        style: {
...
export function Username(username, site) {
...
export function TotalSolved(total, solved) {
  return new Item("g", {
    id: "total-solved",
    style: {
...
export function Solved(problem) {
        ...
        children: [
          ...
          new Item("line", {
            ...
            style: {
              ...
              "stroke-width": "4px",
              "stroke-dasharray": `${
                300 * (problem[difficulties[i]].solved / problem[difficulties[i]].total)
              } 10000`,
              "stroke-linecap": "round",
            },
          }),
...
export function Gradient(id, colors, ratio = 0) {
